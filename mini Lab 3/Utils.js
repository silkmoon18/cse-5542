...
class Component {
    ...
    processMatrixStack(matrixStack) {
        mat4.multiply(matrixStack.top, this.transformMatrix);
        this.shape.draw();
    }
}
...
class Shape {
    ...
    draw(index, matrix, mode) {
        let color = this.colorStack.dataList[index];
        ...
        gl.drawArrays(mode, 0, this.vertexPositionBuffer.numItems);
    }
}
